...
namespace expand_protocol
{
	...
	protected:
		...
		void handleTopicAliveMessage(TopicAliveMessage *);
		void handleTopicOnlineMessage(TopicOnlineMessage *);
		void handleTopicOfflineMessage(TopicOfflineMessage *);
		void handleTopicLocateGpsMessage(TopicLocateMessageGps *);
		void handleTopicLocateLbsMessage(TopicLocateMessageLbs *);
		void handleTopicLocateAppMessage(TopicLocateMessageApp *);
		void handleTopicAlarmLowpowerMessage(TopicAlarmMessageLowpower *);
		void handleTopicAlarmLooseMsg(TopicAlarmMessageLoose *);
		void handleTopicAlarmFleeMsg(TopicAlarmMessageFlee *);
		void handleTopicAlarmLocateLostMsg(TopicAlarmMessageLocateLost *);
		void handleTopicAlarmFenceMsg(TopicAlarmMessageFence *);
		void handleTopicDeviceBindMsg(TopicBindMessage *);
		void handleTopicTaskSubmitMsg(TopicTaskMessage *);
		void handleTopicTaskModifyMsg(TopicTaskModifyMessage *);
		void handleTopicTaskCloseMsg(TopicTaskCloseMessage *);
		void handleTopicLoginMsg(TopicLoginMessage *);
		void handleTopicLogoutMsg(TopicLogoutMessage *);
